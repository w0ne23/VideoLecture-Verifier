...
_ENV_KEYS = [
    ...
    "VERIFIER_ISSUE_JUDGE_BATCH_MAX_WORKERS",
    "VERIFIER_ISSUE_DETECTOR_BATCH_SIZE",
    "VERIFIER_MODEL",
    "VERIFIER_CLAIM_EXTRACT_MODEL",
    "VERIFIER_CLAIM_EXTRACT_BATCH_SIZE",
    "VERIFIER_CLAIM_EXTRACT_MAX_WORKERS",
    "VERIFIER_CLAIM_EXTRACT_CONTEXT_MODE",
    "VERIFIER_CLAIM_EXTRACT_BATCH_MODE",
    "VERIFIER_CLAIM_EXTRACT_CONTEXT_PREV",
    "VERIFIER_CLAIM_EXTRACT_CONTEXT_NEXT",
    "VERIFIER_CLAIM_EXTRACT_CONTEXT_GROUP_SIZE",
